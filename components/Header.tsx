...
export default function Header() {
    ...
    return (
        <header className="sticky top-0 z-50">
            {/* ---------------------------
          TIER 1: Utility Bar (date + categories + actions)
          (No duplicate “Stories/Focus/Video”)
      ---------------------------- */}
            <div className="bg-[hsl(var(--primary))] text-white border-b border-white/10">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 h-10 grid grid-cols-3 items-center gap-3">
                    ...
                    {/* Center: categories (Foxiz-like). Hidden on mobile. */}
            ...
            {/* ---------------------------
          TIER 2: Main Nav Bar (logo + main nav + partner)
      ---------------------------- */}
            ...
            <span className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-white border border-white/30">
                            ...
                            <details className="group">
                                ...
                                <div
                                    className={[
                                        ...
                                        "text-ink", // ✅ IMPORTANT: stop inheriting text-white
                                        "z-[90]",
                                    ].join(" ")}
                                >
                                    <div className="p-2">
                ...
                {s.label}
                    ...
                    <div className="flex items-center justify-end min-w-[140px]">
                        <a
                            ...
                            className="inline-flex items-center rounded-full bg-[hsl(var(--accent))] text-[hsl(var(--primary))] font-bold px-5 py-2 text-sm
              hover:-translate-y-0.5 transition shadow-sm"
                ...
                {/* Mobile nav (tier 2 only) */}
                <div className="lg:hidden border-t border-white/15">
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-2 flex gap-4 overflow-x-auto text-sm">
                        {mainNav.map((item) => {
                            const active = isActiveMain(item.href);
                            return (
                                <a
